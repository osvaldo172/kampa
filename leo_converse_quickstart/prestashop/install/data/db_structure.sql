...
CREATE TABLE `PREFIX_customization_field_lang` (
  ...
  PRIMARY KEY (`id_customization_field`,`id_shop`,`id_lang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_leomanagewidget_backup` (
...
CREATE TABLE `PREFIX_leomanagewidget_column` (
...
CREATE TABLE `PREFIX_leomanagewidget_content` (
...
CREATE TABLE `PREFIX_order_slip` (
  ...
  `order_slip_type` tinyint(1) NOT NULL DEFAULT '0',
  `date_add` datetime NOT NULL,
  `date_upd` datetime NOT NULL,
...
CREATE TABLE `PREFIX_product_attribute` (
  ...
  `quantity` int(10) NOT NULL DEFAULT '0',
  `weight` decimal(20,6) NOT NULL DEFAULT '0.000000',
  `unit_price_impact` decimal(20,6) DEFAULT NULL,
